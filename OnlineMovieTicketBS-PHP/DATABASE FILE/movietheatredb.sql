...
(1, 3, 'RRR', 'Taika Waititi · Karen Gillan · Natalie Portman · Christian Bale · Chris Hemsworth · Jaimie Alexander · Chris Pratt · Matt Damon.', 'Chris Hemsworth\' Thor: Love and Thunder is an upcoming American superhero film based on the Marvel Comics character Thor, produced by Marvel Studios and distributed by Walt Disney Studios Motion Pictures. It is intended to be the direct sequel to Thor: Ragnarok and the 29th film in the Marvel Cinematic Universe.', '2020-03-04', 'images/tim.jpg', 'https://youtu.be/tgB1wUcmbbw', 0),
